...
<body style="padding-top: 4.3rem">
    ...
    $sql = "SELECT * FROM `boys_wear` WHERE production_status='on going';";
    $sql1 = "SELECT * FROM `boys_wear` WHERE production_status='on hand';";
    ...
    <div class="jumbotron">
        ...
        <div class="row">
            ...
            $sql2 = "SELECT * FROM `boys_wear_image` WHERE item_number='$item_number';";
            ...
            while ( $row = $result2->fetch_assoc() ):
                    ...
                    <a href="./../Cord/UpdateDelete.php?delete=<?php echo $item_number; ?>&database=boys_wear" class="btn btn-outline-danger btn-lg">Delete</a></h6>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form method="post" action="./../Cord/UpdateDelete.php?database=boys_wear">
