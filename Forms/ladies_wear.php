...
<body style="padding-top: 4.3rem">
    ...
    $sql = "SELECT * FROM `ladies_wear` WHERE production_status='on going';";
    $sql1 = "SELECT * FROM `ladies_wear` WHERE production_status='on hand';";
    ...
    <div class="jumbotron">
        <div class="row">
            <div class="col-12 text-center">
                <h3 class="hedding">ladies wear</h3>
                <hr>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            $sql2 = "SELECT * FROM `ladies_wear_image` WHERE item_number='$item_number';";
            ...
            while ( $row = $result2->fetch_assoc() ):
                    ...
                    <a href="./../Cord/UpdateDelete.php?delete=<?php echo $item_number; ?>&database=ladies_wear" class="btn btn-outline-danger btn-lg">Delete</a></h6>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form method="post" action="./../Cord/UpdateDelete.php?database=ladies_wear">
